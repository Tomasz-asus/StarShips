document.addEventListener("DOMContentLoaded", (event) => {
  ...
  function renderstarshipsList(starships) {
    const starshipsHtmlElems = starships.map((starships, index) =>
      getstarshipsLayout(starships, index)
    );
  ...
  function deleteChild() {
    const e = document.querySelector("#starships-container");
    e.innerHTML = "";
  }
  const clearingLoadedData = (document.getElementById(
